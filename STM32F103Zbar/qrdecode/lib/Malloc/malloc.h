...
#define MEM1_MAX_SIZE			55*1024  						//最大管理内存 40K
#define MEM1_ALLOC_TABLE_SIZE	MEM1_MAX_SIZE/MEM1_BLOCK_SIZE 	//内存表大小

//mem2内存参数设定.mem2的内存池处于外部SRAM里面
#define MEM2_BLOCK_SIZE			32  	  						//内存块大小为32字节
#define MEM2_MAX_SIZE			990 *1024  						//最大管理内存960K
...
void mymemset(void *s,u8 c,u32 num)  ;	//设置内存
void mymemcpy(void *des,void *src,u32 len)  ;//复制内存     
